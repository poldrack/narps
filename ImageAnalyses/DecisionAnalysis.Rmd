...
dist_hyp_notesting = lm(z_mean_distance ~ used_fmriprep_data + fwhm + package + movement_modeling,
            data = merged_df)   
...
dist_hyp_nomovement = lm(z_mean_distance ~ used_fmriprep_data + fwhm + package + testing,
            data = merged_df)   
